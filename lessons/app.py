...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.main_button_1.grid(row=3, column=2,columnspan=1, padx=(20, 20), pady=(20, 20), sticky="nsew")
        ...
        self.account_frame.grid(row=0, column=2, padx=(20, 20), pady=(20, 0), sticky="nsew")
        ...
        self.label_email.grid(row=1, column=0, padx=10, pady=10, sticky="")
        ...
        self.label_password.grid(row=2, column=0, padx=10, pady=10, sticky="")
        ...
        self.label_radio_group.grid(row=0, column=1, padx=10, pady=10, sticky="")
        ...
        self.label_firstname.grid(row=0, column=0,padx=5, pady=(10, 10), sticky="")
        self.entry_firstname = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="first name")
        self.entry_firstname.grid(row=0, column=1,padx=5, pady=(10, 10), sticky="E")

        self.label_lastname = customtkinter.CTkLabel(master=self.slider_progressbar_frame, text="Last Name :")
        self.label_lastname.grid(row=1, column=0,padx=5, pady=(5, 5), sticky="")
        self.entry_lastname = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="Last name")
        self.entry_lastname.grid(row=1, column=1,padx=5, pady=(5, 5), sticky="E")

        self.label_address = customtkinter.CTkLabel(master=self.slider_progressbar_frame, text="Address :")
        self.label_address.grid(row=2, column=0,padx=5, pady=(5, 5), sticky="")
        self.entry_address = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="Address")
        self.entry_address.grid(row=2, column=1,padx=5, pady=(5, 5), sticky="E")

        self.label_city = customtkinter.CTkLabel(master=self.slider_progressbar_frame, text="City :")
        self.label_city.grid(row=3, column=0,padx=5, pady=(5, 5), sticky="")
        self.entry_city = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="City")
        self.entry_city.grid(row=3, column=1,padx=5, pady=(5, 5), sticky="E")

        self.label_state = customtkinter.CTkLabel(master=self.slider_progressbar_frame, text="State :")
        self.label_state.grid(row=4, column=0,padx=5, pady=(5, 5), sticky="")
        self.entry_state = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="State")
        self.entry_state.grid(row=4, column=1,padx=5, pady=(5, 5), sticky="E")

        self.label_phone = customtkinter.CTkLabel(master=self.slider_progressbar_frame, text="Phone :")
        self.label_phone.grid(row=5, column=0,padx=5, pady=(5, 5), sticky="")
        self.entry_phone = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="Phone ")
        self.entry_phone.grid(row=5, column=1,padx=5, pady=(5, 5), sticky="E")
        # self.entry_password = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="last name")
        # self.entry_password.grid(row=1, column=0, padx=20, pady=(10, 10))
        # self.entry_password = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="address")
        # self.entry_password.grid(row=1, column=0, padx=20, pady=(10, 10))
        # self.entry_password = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="city")
        # self.entry_password.grid(row=1, column=0, padx=20, pady=(10, 10))
        # self.entry_password = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="state")
        # self.entry_password.grid(row=1, column=0, padx=20, pady=(10, 10))
        # self.entry_password = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="code number")
        # self.entry_password.grid(row=1, column=0, padx=20, pady=(10, 10))
        # self.entry_password = customtkinter.CTkEntry(self.slider_progressbar_frame, placeholder_text="phone")
        # self.entry_password.grid(row=1, column=0, padx=20, pady=(10, 10))
